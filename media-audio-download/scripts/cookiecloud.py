...
This is a skill-scoped copy so Docker images don't depend on host tooling.
...
def resolve_cookie_header(
    *,
    ...
    3) CookieCloud (COOKIECLOUD* env vars)
    """
    ...
    if not cfg:
        raise SystemExit(
            "Missing cookies. Provide --cookie, set an env var, or set COOKIECLOUDUUID/COOKIECLOUDPASSWORD."
        )
